...
function sitemap() {
  document.querySelector('*').scrollTo(0,0);
  //Title upgrade form hare
  document.getElementById('chapter1').innerHTML = "sitemap";
  //notes making function 
  //create new div

divElement1.className = "box";
divElement1.id = "box1";
divElement1.innerHTML = '<urlset<url><loc>https://classnotes.tech/</loc><lastmod>2021-06-14T12:53:06+00:00</lastmod><priority>1.00</priority></url><url><loc>https://classnotes.tech/index.html</loc><lastmod>2021-06-14T12:53:06+00:00</lastmod><priority>0.80</priority></url></urlset>';
ContentContainer.appendChild(divElement1);
